...
- The camera's PTZ setting must be enabled at 57600 baud and Pelco type D (address 1), otherwise the interface board will not recognize the commands and the optical zoom will not work.
